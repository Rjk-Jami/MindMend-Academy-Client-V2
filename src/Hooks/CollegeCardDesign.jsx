        ...
        <div className="card card-compact w-full bg-sky-300 bg-opacity-20 shadow-xl">
                        ...
                        <div className="card-body">
                            ...
                            <div className="card-actions justify-end">
                                <p></p>
                                <Link to={`/colleges/${college._id}`}><button className="group flex w-44 cursor-pointer select-none items-center justify-center rounded-md  px-6 py-2 text-black hover:text-success  transition">
                                    Details
